...
type ActionCardCreationProps = {
    className?: string;
  };

function ActionCardCreation({}: ActionCardCreationProps) {
    return (
        <div className="self-stretch px-2.5 py-[15px] bg-blue-100 rounded-[33px] flex-col justify-center items-center gap-[15px] flex">
            <div className="self-stretch justify-center items-center gap-2.5 inline-flex">
              ...
              <div className="grow shrink basis-0 text-blue-900 text-base font-bold font-inter">Nouveau tweet compo</div>
            </div>
...
export default ActionCardCreation;